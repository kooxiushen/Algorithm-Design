...
// *********************************************************
//
// Hash table (linear probing); traces the search path for one found
// target and one not-found target.
//
...
int main(int argc, char *argv[])
{
    ...
    for (int t = 0; t < 2; t++)
    {
        ...
        // Probe until found or an empty slot.
        ...
        // Output line in the sample format.
